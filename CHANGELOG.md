...
## v5.7 - 2026/01/31 [#194](https://github.com/bright9th/stella-nova-archive/pull/194)
...
## v5.6 - 2026/01/13 [#190](https://github.com/bright9th/stella-nova-archive/pull/190)

- Added auto scroll on overlay hover
  - Toggleable inside Overlay toolbox

## v5.5 - 2026/01/12 [#190](https://github.com/bright9th/stella-nova-archive/pull/190)
...
## v5.4 - 2026/01/11 [#185](https://github.com/bright9th/stella-nova-archive/pull/185)

- Added real time JSON -> ItemData conversion

## v5.3 - 2026/01/11 [#182](https://github.com/bright9th/stella-nova-archive/pull/182)
...
## v5.2 - 2026/01/11 [#180](https://github.com/bright9th/stella-nova-archive/pull/180)
...
## v5.1 - 2026/01/09 [#169](https://github.com/bright9th/stella-nova-archive/pull/169)
...
## v5.0 - 2026/01/03 [#160](https://github.com/bright9th/stella-nova-archive/pull/160)
...
## v4.6 - 2026/01/03 [#158](https://github.com/bright9th/stella-nova-archive/pull/158)

- [backend] Added custom css classes
  - most reused related: `flex`, `width`, `height`

## v4.5 - 2026/01/03 [#154](https://github.com/bright9th/stella-nova-archive/pull/154)

- [backend] Added middle hook
  - useSearchQuery, useFilterQuery, useSortQuery, useArchive, useOverlay

## v4.4 - 2026/01/02 [#149](https://github.com/bright9th/stella-nova-archive/pull/149)

- [backend] Turn props into context
  - Added ArchiveContext
  - Moved some existing contexts to respective folders

## v4.3 - 2026/01/01 [#146](https://github.com/bright9th/stella-nova-archive/pull/146)
...
## v4.2 - 2025/12/31 [#138](https://github.com/bright9th/stella-nova-archive/pull/138)

- [backend] Collapse big component into multiple small components
- [backend] Added reusable component `ButtonInput`

## v4.1 - 2025/12/29 [#124](https://github.com/bright9th/stella-nova-archive/pull/124)

- Added version changelog & workflow

## v4.0 - 2025/12/28 [#114](https://github.com/bright9th/stella-nova-archive/pull/114)

- Built-in editor for archive page.

## v3.0 - 2025/12/19 [#80](https://github.com/bright9th/stella-nova-archive/pull/80)

- UI & UX cleanup.

## v2.0 - 2025/12/18 [#75](https://github.com/bright9th/stella-nova-archive/pull/75)

- Basic translation archive viewing tab.

## v1.0 - 2025/12/07 [#55](https://github.com/bright9th/stella-nova-archive/pull/55)
